...
export const projects = [
  {
    title: "數位分身前端系統",
    category: "前端 / 數位分身",
    description: "開發數位分身的前端介面與互動,串接後端資料流呈現即時狀態與 3D 視覺化。",
    image: "",
  ...
  },
  {
    title: "REST API 服務",
    category: "後端開發",
    description: "設計並開發專案的 REST API,規劃系統資料流與服務介面,支撐前端與其他系統介接。",
    image: "",
  ...
  },
  {
    title: "資料庫架構設計",
    category: "資料庫",
    description: "規劃資料庫架構與資料模型,進行索引與查詢效能調校,確保大量資料下的穩定與效率。",
    image: "",
